...
const CreateProduct = () => {
    ...
    return <StyledCreateProduct>
        <StyledForm onSubmit={handleSubmit}>
            ...
            <input type="file" accept="images/" onChange={handleProductImageUpload} required/>
            <select onChange={(e) => setBrand(e.target.value)} required>
                <option value="">select brand</option>
                <option value="meat">meat</option>
                <option value="vgetable">vegetable</option>
            ...
            <input type="text" required placeholder="Description" onChange={(e) => setDesc(e.target.value)}/>
            <PrimaryButton type="submit"> Upload</PrimaryButton>
        </StyledForm>
        <ImagePreview>
            {productImg ? (
                <>
                    <img src={productImg} alt="pic" />
                </>
                ) :( 
